...
def index(name=None):
    ...
    try:
        if query:
            ...
            f= open("./scraper/link.txt","w+")
            f.write("http://stackoverflow.com/questions/"+str(git_search_result[0].so_item.answer_id))
            os.system('node ./scraper/stackoverflow_scraper.js')
